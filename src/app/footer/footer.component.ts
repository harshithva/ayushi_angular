...
export class FooterComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private _contactService: ContactUsService) { }
  ...
  onSubmit(form){
    ...
    this.contactFormSubmit.value.body="<h1>"+this.contactForm.value.name+" </h1><br><h2>"+this.contactForm.value.email+" </h2><br><p>"+this.contactForm.value.body+" </p>";
